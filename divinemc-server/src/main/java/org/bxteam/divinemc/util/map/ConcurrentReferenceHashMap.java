...
import org.bxteam.divinemc.util.Assert;
import org.bxteam.divinemc.util.ObjectUtil;
    ...
    protected static final class Entry<K, V> implements Map.Entry<K, V> {
        ...
        public boolean equals(@Nullable Object other) {
            return (this == other || (other instanceof Map.Entry<?, ?> that &&
                ObjectUtil.nullSafeEquals(getKey(), that.getKey()) &&
                ObjectUtil.nullSafeEquals(getValue(), that.getValue())));
        }
